						...
						for (var r = 0; r < s; r++) {
							if (o[r].Material !== "" && o[r].Plant !== "" && (o[r].GoodsMovementType === "201" || o[r].GoodsMovementType === "202" || o[
								...
								oGOODS_MVMT.GOODS_MVMT.push({
									...
									MaterialDocument: o[r].MaterialDocument,
									MaterialDocumentItem: o[r].MaterialDocumentItem,
									MaterialDocumentRecordType: o[r].MaterialDocumentRecordType,
									MaterialDocumentYear: o[r].MaterialDocumentYear
